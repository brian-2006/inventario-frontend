...
const  InventarioBioseguridadTest = ()=> {

    const [rows, setRows] = useState([]);       
    const [loteRows, setLoteRows] = useState([]); 

    useEffect(() => {
        axios.get(`http://127.0.0.1:8000/inventarioPrincipal/getInventoryRowsJson/${TypeInventory.Bioseguridad}/`)
        .then(response => {
...
export default InventarioBioseguridadTest;
